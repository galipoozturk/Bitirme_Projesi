            ...
            modelBuilder.Entity("NTierSample.Model.Entities.ListItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 8, 5, 14, 44, 5, 734, DateTimeKind.Local).AddTicks(1203),
                            IsActive = true,
                            ProductId = 1,
                            ShoppingListId = 1
                        });
            ...
            modelBuilder.Entity("NTierSample.Model.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 8, 5, 14, 44, 5, 733, DateTimeKind.Local).AddTicks(9112),
            ...
            modelBuilder.Entity("NTierSample.Model.Entities.ShoppingList", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 8, 5, 14, 44, 5, 734, DateTimeKind.Local).AddTicks(674),
                            IsActive = true,
                            Name = "Martys List",
                            Status = 0,
                            UserId = 1
            ...
            modelBuilder.Entity("NTierSample.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 8, 5, 14, 44, 5, 734, DateTimeKind.Local).AddTicks(200),
                            Email = "akb@mail.com",
                            FirstName = "Marty",
                            IsActive = true,
                            LastName = "McFly",
